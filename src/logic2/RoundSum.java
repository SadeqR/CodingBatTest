...
write a separate helper "public int round10(int num) {" and call it 
3 times. Write the helper entirely below and at the same indent level 
as roundSum().
...
public class RoundSum {
	...
	public int round10(int num) {
		...
		else if(num%10<5) num = num - num%10;
		return num;
	}
}
