...
a, just return a without b. (Note: one way to compute the number of 
digits of a non-negative int n is to convert it to a string with 
...
public class SumLit {
	public int sumLimit(int a, int b) {
		...
		if(ab.length()==aa.length()) return a+b;
		return a;
	}
}
